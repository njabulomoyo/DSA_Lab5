...
window.close()
        ...
        with open('courses.csv', 'w', newline='') as f:
            writer = csv.DictWriter(f, fieldnames=['course_id', 'name', 'instructor', 'days', 'time', 'max_students', 'enrolled_students'])
            writer.writeheader()
            for c in self.courses.values():
                writer.writerow({
    ...
    def register_student(self, student_id, fullname, email):
        if student_id in self.students:
            print("⚠️ Student already registered.")
            return
        self.students[student_id] = Student(student_id, fullname, email)
        print(f"✅ Registered {fullname} ({student_id})")
    ...
    def enroll_student(self, student_id, course_id):
        ...
        print(f"✅ {student.fullname} enrolled in {course.name}")
    ...
    def drop_course(self, student_id, course_id):
        ...
        if course_id in student.registered_courses:
            ...
            print("⚠️ Not enrolled in this course.")
